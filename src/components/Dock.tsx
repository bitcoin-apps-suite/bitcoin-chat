...
import { Wallet, Mail, Music, FileText, HardDrive, Calendar, Search, Table, Share2, Briefcase, Store, Wifi, Volume2, Battery, Clock, TrendingUp, Building2, Shield, Palette, GraduationCap, Paintbrush, Video, MessageSquare } from 'lucide-react';
import './Dock.css';
...
const Dock: React.FC = () => {
  ...
  const dockApps: DockApp[] = [
    ...
    { name: 'Bitcoin Chat', icon: MessageSquare, color: 'text-orange-500', url: 'https://bitcoin-chat.vercel.app', current: true },
