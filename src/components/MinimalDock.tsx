...
const MinimalDock: React.FC<MinimalDockProps> = ({ currentApp = 'bitcoin-os' }) => {
  ...
  const dockApps: DockApp[] = [
    ...
    { id: 'bapps-store', name: 'Bitcoin Apps Store', icon: Store, color: 'rainbow', url: 'https://bitcoinapps.store/', isImage: true, current: currentApp === 'bapps-store' },
  ...
  const rightSideApps: DockApp[] = [
    ...
    { id: 'bapps-mini', name: 'BAPPS', icon: Store, color: 'text-orange-500', url: 'https://bitcoinapps.store/' },
